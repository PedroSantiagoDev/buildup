...
public interface UserRepository extends JpaRepository<UserEntity, UUID> {
    ...
    @Query("SELECT u FROM UserEntity u LEFT JOIN FETCH u.company LEFT JOIN FETCH u.roles WHERE u.email = :email")
    Optional<UserEntity> findByEmailWithCompanyAndRoles(@Param("email") String email);
